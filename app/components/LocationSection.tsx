  ...
  const locations: Location[] = [
    {
      ...
      description: texts.locationDescription,
                  ...
                  >
                    ...
                    <div className="pd---content-inside-card">
                      <div className="inner-container locations-content">
                        ...
                        <p className="mg-bottom-32px">{location.description}</p>
                        ...
                        >
                          <div className="link-text">
                            <div className="text-200 medium text-uppercase">{location.phone}</div>
                          </div>
                          <div className="line-rounded-icon link-icon-right mg-left-16px"></div>
                        </button>
                      </div>
                    </div>
                  </div>
