    ...
    const observerCallback = (entries: IntersectionObserverEntry[]) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          const bgText = entry.target.querySelector(
            ".bg-text-wrapper"
          ) as HTMLElement;
          if (bgText) {
            setTimeout(() => {
  ...
  const locations: Location[] = [
    {
      ...
      description:
        "Showroom No- 7, AJD Building, Umm Ramool, Rashidiya, Dubai, UAE",
                  ...
                  >
                    <div className="flex flex-col lg:flex-row lg:gap-6">
                      <a
                        ...
                        className="block w-full lg:w-[60%]"
                        style={{ height: "400px" }}
                      >
                        <div className="image-wrapper location-imagen-card h-full">
                          <iframe
                      ...
                      <div className="pd---content-inside-card w-full lg:w-[40%] lg:flex lg:items-center">
